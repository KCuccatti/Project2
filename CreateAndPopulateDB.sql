...
(
    ...
    FOREIGN KEY (year, make, model) REFERENCES VehicleModelYear (year, make, model),
...
INSERT INTO Dealers (name, address, city, state, zip, phone) VALUES (
'Texas Pre-owned Cars', '555 Roland Ave', 'Coppell', 'TX', '75019','555-666-7777');
COMMIT;

 INSERT INTO Dealers (name, address, city, state, zip, phone) VALUES (
'Bobs Auto Mart', '1235 Smithton Lane', 'Coppell', 'TX', '75019','334-643-4335');

 INSERT INTO Dealers (name, address, city, state, zip, phone) VALUES (
'John''s RipOff Dealership', '18259 Irving Blvd', 'Irving', 'TX', '75232','394-339-4949');

 INSERT INTO Dealers (name, address, city, state, zip, phone) VALUES (
'Jakes Autohouse', '3212 Bluebird Lane', 'Coppell', 'TX', '75019','847-303-4030');

 INSERT INTO Dealers (name, address, city, state, zip, phone) VALUES (
'A1 Auto', '1219 SE 5Th Street', 'Dallas', 'TX', '75232','217-929-3939');

 INSERT INTO Dealers (name, address, city, state, zip, phone) VALUES (
'Wheels Plus', '3913 Hartford', 'Lewisville', 'TX', '75423','239-393-4949');

 INSERT INTO Dealers (name, address, city, state, zip, phone) VALUES (
'Carson Autoworks', '1527 NE 10th St', 'Irving', 'TX', '75211','355-369-5459');

 INSERT INTO Dealers (name, address, city, state, zip, phone) VALUES (
'Jones Automotive', '195 Jacquelin Ave', 'Dallas', 'TX', '75219','646-303-5983');

commit;
  


INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price, body_style, engine, transmission)
VALUES (1, '2013', 'Ford', 'Mustang', 398403, 104000, 800, './image/Mustang.jpg', 14900, '2 door coupe', '3.7L V6', 'Manual');

INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price)
VALUES (1, '2007', 'Ford', 'Ranger', 393914, 40304, 800, './image/carImage.jpg', 16300);

INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price)
VALUES (3, '1998', 'Buick', 'Regal', 34231, 167000, 1500, './image/carImage.jpg', 12700);

INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price)
VALUES (3, '2010', 'Ford', 'Fusion', 38483, 18000, 900, './image/carImage.jpg', 18250);

INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price)
VALUES (2, '2010', 'Ford', 'Edge', 38483, 18000, 1000, './image/carImage.jpg', 13000);

INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price, body_style, engine, transmission)
VALUES (2, '2013', 'Ford', 'Mustang', 39493, 57000, 2500, './image/Mustang2.jpg', 16750, '2 door coupe', '5.0L V8', 'Manual');

INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price, body_style, engine, transmission)
VALUES (2, '2013', 'Ford', 'Mustang', 14493, 36000, 2000, './image/Mustang3.jpg', 21000, '2 door coupe', '3.7L V6', 'Automatic');

INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price, body_style, engine, transmission)
VALUES (2, '2013', 'Ford', 'Mustang', 39455, 125000, 900, './image/Mustang4.jpg', 18500, '2 door coupe', '3.7L V6', 'Manual');

INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price, body_style, engine, transmission)
VALUES (3, '2008', 'Dodge', 'Challenger', 48193, 45000, 2000, './image/Challenger.jpg', 12000, '2 door coupe', '3.5L V6', 'Automatic');

INSERT INTO DealerInventory (dealer_id, year, make, model, stock_number, mileage, income, image, price, body_style, engine, transmission)
VALUES (8, '2008', 'Dodge', 'Challenger', 86487, 54000, 2500, './image/Challenger2.jpg', 16500, '2 door coupe', '5.6L V8 Hemi', 'Automatic');
